	...
	return (
		<>
			...
			<div className="min-h-screen flex flex-col bg-background text-foreground">
				<Navbar className="sticky top-0 z-50 border-b border-foreground/10 bg-background/80 backdrop-blur supports-[backdrop-filter]:bg-background/70 px-4 md:px-6">
					<NavbarBrand>
						<NavLink
							to="/"
